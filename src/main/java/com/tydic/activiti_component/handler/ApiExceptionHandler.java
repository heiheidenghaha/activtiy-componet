package com.tydic.activiti_component.handler;
...
import com.tydic.activiti_component.constant.SystemCode;
import com.tydic.activiti_component.entity.ResponseVO;
import com.tydic.activiti_component.exception.BusinessException;
...
public class ApiExceptionHandler {
    ...
    @ResponseStatus(code = HttpStatus.INTERNAL_SERVER_ERROR)
    @ResponseBody
    public ResponseVO handle(ActivitiException e) {
        LOGGER.error("工作流异常", e);
        return ResponseVO.build(SystemCode.E_ERROR, "工作流异常", null);
    }
}
